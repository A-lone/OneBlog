    ...
    public class BlogConfig
    {
        ...
        public static string FileExtension
        {
            get
            {
                ...
                return _fileExtension ?? (_fileExtension = WebConfigurationManager.AppSettings["OneBlog.FileExtension"] ?? ".aspx");
            }
        }
        ...
        public static string VirtualPath
        {
            get
            {
                return _virtualPath?? (_virtualPath = WebConfigurationManager.AppSettings["OneBlog.VirtualPath"] ?? "~/");
            }
        }
        #endregion
        ...
        public static string MobileServices
        {
            get
            {
                return _mobileServices ?? (_mobileServices = WebConfigurationManager.AppSettings["OneBlog.MobileDevices"] ??
        ...
        public static string ReservedBlogNames
        {
            get
            {
                return _reservedBlogNames ?? (_reservedBlogNames = WebConfigurationManager.AppSettings["OneBlog.ReservedBlogNames"] ?? @"(account|admin|api|app_code|app_data|app_globalresources|bin|content|editors|modules|pics|scripts|setup|templates|tests|themes|user controls|widgets|post|page|category|author|tag|calendar)");
            }
        }
        ...
        public static string AdministratorRole
        {
            get
            {
                return _administrativeRole ?? (_administrativeRole = WebConfigurationManager.AppSettings["OneBlog.AdminRole"] ?? "administrators");
            }
        }
        #endregion
        ...
        public static string AnonymousRole
        {
            get
            {
                return _anonymousRole ?? (_anonymousRole = WebConfigurationManager.AppSettings["OneBlog.AnonymousRole"] ?? "Anonymous");
            }
        }
        ...
        public static string EditorsRole
        {
            get
            {
                return _editorsRole ?? (_editorsRole = WebConfigurationManager.AppSettings["OneBlog.EditorsRole"] ?? "Editors");
            }
        }
        ...
        public static int GenericPageSize
        {
            get
            {
                var tmp = WebConfigurationManager.AppSettings["OneBlog.GenericPageSize"];
        ...
        public static bool SingleSignOn
        {
            get
            {
                ...
                {
                    string setting = WebConfigurationManager.AppSettings["OneBlog.SingleSignOn"] ?? "false";
        ...
        public static string SiteMapUrlSet
        {
            get
            {
                return _siteMapUrlSet ?? (_siteMapUrlSet = WebConfigurationManager.AppSettings["OneBlog.SiteMapUrlSet"] 
        ...
        public static string DefaultEditor
        {
            get
            {
                return string.IsNullOrEmpty(WebConfigurationManager.AppSettings["OneBlog.DefaultEditor"])
                    ? "~/areas/admin/editors/markdown/editor.cshtml"
                    : WebConfigurationManager.AppSettings["OneBlog.DefaultEditor"];
            }
        }
        #endregion
        ...
        public static string GalleryFeedUrl
        {
            get
            {
                return string.IsNullOrEmpty(WebConfigurationManager.AppSettings["OneBlog.GalleryFeedUrl"])
                    ? "http://dnbe.net/v01/nuget"
                    : WebConfigurationManager.AppSettings["OneBlog.GalleryFeedUrl"];
            }
        }
        #endregion
        ...
        public static string UsageScenario
        {
            get
            {
                return string.IsNullOrEmpty(WebConfigurationManager.AppSettings["OneBlog.UsageScenario"])
                    ? "singleblog"
                    : WebConfigurationManager.AppSettings["OneBlog.UsageScenario"];
            }
        }
        #endregion
    }
