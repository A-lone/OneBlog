...
namespace OneBlog.Core.Providers
{
    ...
    public partial class DbBlogProvider : BlogProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            {
                // default to OneBlog
                config["connectionStringName"] = "OneBlog";
            }
        ...
        /// <summary>
        /// Saves the current OneBlog rights.
        /// </summary>
        ...
        public override void SaveCustomField(CustomField field)
        {
            using (var conn = this.CreateConnection())
            {
                if (conn.HasConnection)
                {
                    string conPrv = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OneBlog"].ProviderName;
