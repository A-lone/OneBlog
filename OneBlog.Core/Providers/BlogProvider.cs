namespace OneBlog.Core.Providers
{
    ...
    public abstract class BlogProvider : ProviderBase
    {
        ...
        public abstract void SaveCustomField(OneBlog.Core.Data.Models.CustomField field);
        /// <summary>
        /// Fills list of custom fields for a blog
        /// </summary>
        /// <returns>List of custom fields</returns>
        public abstract List<OneBlog.Core.Data.Models.CustomField> FillCustomFields();
        /// <summary>
        /// Deletes custom field
        /// </summary>
        /// <param name="field">Object field</param>
        public abstract void DeleteCustomField(OneBlog.Core.Data.Models.CustomField field);
        /// <summary>
