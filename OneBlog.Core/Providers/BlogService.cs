...
namespace OneBlog.Core.Providers
{
    ...
    public static class BlogService
    {
        ...
        /// <summary>
        /// Saves all of the current OneBlog rights to the provider.
        /// </summary>
        ...
        public static void SaveCustomField(OneBlog.Core.Data.Models.CustomField field)
        {
        ...
        public static List<OneBlog.Core.Data.Models.CustomField> FillCustomFields()
        {
        ...
        public static void DeleteCustomField(OneBlog.Core.Data.Models.CustomField field)
        {
        ...
        private static void LoadProviders()
        {
            ...
            if (_provider == null)
            {
                lock (TheLock)
                {
                    ...
                    if (_provider == null)
                    {
                        ...
                        var section =
                            (BlogProviderSection)WebConfigurationManager.GetSection("OneBlog/blogProvider");
            ...
            if (_fileStorageProvider == null)
            {
                lock (TheLock)
                {
                    if (_fileStorageProvider == null)
                    {
                        var section = (BlogFileSystemProviderSection)WebConfigurationManager.GetSection("OneBlog/blogFileSystemProvider");
