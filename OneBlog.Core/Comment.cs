namespace OneBlog.Core
{
    ...
    public sealed class Comment : IComparable<Comment>, IPublishable
    {
        ...
        /// <param name="arg">The <see cref="OneBlog.Core.ServingEventArgs"/> instance containing the event data.</param>
        ...
        /// </summary>
        /// <param name="eventArgs">The <see cref="OneBlog.Core.ServingEventArgs"/> instance containing the event data.</param>
