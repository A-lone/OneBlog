namespace OneBlog.Core
{
    ...
    public class AuthorProfile : BusinessBase<AuthorProfile, string>
    {
        ...
        /// The profiles.
        /// </summary>
        private static readonly ConcurrentDictionary<Guid, List<AuthorProfile>> profiles = new ConcurrentDictionary<Guid, List<AuthorProfile>>();
            ...
            Blog.Saved += (s, e) =>
            {
                if (e.Action == SaveAction.Delete)
                {
                    ...
                    if (blog != null)
                    {
                        ...
                        {
                            List<AuthorProfile> list = null;
                            profiles.TryRemove(blog.Id, out list);
                        }
                    }
                }
            };
        ...
        public static List<AuthorProfile> Profiles
        {
            get
            {
                ...
                {
                    var profileList = BlogService.FillProfiles();
                    profiles.TryAdd(Blog.CurrentInstance.Id, profileList);
                }
        ...
        {
            List<AuthorProfile> list = null;
            profiles.TryRemove(blogId, out list);
        }
