...
namespace OneBlog.Core.FileSystem
{
    /// <summary>
    ...
    public class FileSystemUtilities
    {
        ...
        public string DumpProvider(string NewProviderName, string ArchiveOutputLocation)
        {
            ...
            BlogFileSystemProviderSection section = (BlogFileSystemProviderSection)config.GetSection("OneBlog/blogFileSystemProvider");
            var olderProivder = section.DefaultProvider.Clone().ToString();
            section.DefaultProvider = NewProviderName;
            config.Save();
            ConfigurationManager.RefreshSection("OneBlog/blogFileSystemProvider");
            config = null;
            ...
            {
                section = (BlogFileSystemProviderSection)config.GetSection("OneBlog/blogFileSystemProvider");
        ...
        {
            var section = (BlogProviderSection)WebConfigurationManager.GetSection("OneBlog/blogProvider");
