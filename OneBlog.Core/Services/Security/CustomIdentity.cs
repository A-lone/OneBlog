namespace OneBlog.Core
{
    ...
    {
        /// <summary>
        /// Gets the type of authentication used by OneBlog.NET.
        /// </summary>
        public string AuthenticationType
        {
            get { return "OneBlog.NET Custom Identity"; }
        }
        ...
        {
            if (CoreUtils.StringIsNullOrWhitespace(username))
                throw new ArgumentNullException("username");

            if (CoreUtils.StringIsNullOrWhitespace(password))
