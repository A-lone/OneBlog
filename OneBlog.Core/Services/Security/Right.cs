...
namespace OneBlog.Core
{
    ...
    public sealed class Right : IHttpModule
    {
        ...
        static Right()
        {
            ...
            var adminRole = OneBlog.Core.BlogConfig.AdministratorRole;
        ...
        public static void RefreshAllRights()
        {
            ...
            lock (staticLockObj)
            {
                ...
                foreach (var pair in OneBlog.Core.Providers.BlogService.FillRights())
                {
                ...
                if (defaultsAdded)
                {
                    OneBlog.Core.Providers.BlogService.SaveRights();
                }
            }
        ...
        /// <summary>
        /// Returns an IEnumerable of all of the Rights that exist on OneBlog.
        /// </summary>
        /// <returns></returns>
        ...
        private readonly Dictionary<Guid, ReadOnlyCollection<string>> _readOnlyRoles = new Dictionary<Guid, ReadOnlyCollection<string>>();
        private readonly Dictionary<Guid, List<string>> _rolesWithRight = new Dictionary<Guid, List<string>>();
