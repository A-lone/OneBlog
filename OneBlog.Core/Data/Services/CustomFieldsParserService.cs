...
namespace OneBlog.Core.Data.Services
{
    /// <summary>
    ...
    public class CustomFieldsParserService
    {
        ...
        {
            var repoItems = OneBlog.Core.Providers.BlogService.FillCustomFields();
        ...
        static void SaveToRepository(List<CustomField> markupFields)
        {
            ...
            foreach (var item in markupFields)
            {
                ...
                if (oItem == null)
                {
                    ...
                    OneBlog.Core.Providers.BlogService.SaveCustomField(item);
                }
            }
        }
