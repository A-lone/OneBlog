...
namespace OneBlog.Core.Data
{
    ...
    public class BlogRepository : IBlogRepository
    {
        ...
        static bool Save(Blog coreBlog, OneBlog.Core.Data.Models.Blog jsonBlog)
        {
        ...
        static OneBlog.Core.Data.Models.Blog ToJson(Blog blog)
        {
            var jb = new OneBlog.Core.Data.Models.Blog
            {
                Id = blog.Id,
                Name = blog.Name,
