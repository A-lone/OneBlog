namespace OneBlog.Core.API.MetaWeblog
{
    ...
    internal class XMLRPCRequest
    {
        ...
        /// </summary>
        /// <remarks>
        ///     OneBlog.NET doesn't require specific AppKeys for API calls.  It is no longer standard practive.
        /// </remarks>
        public string AppKey { get; private set; }

        /// <summary>
        ///     Gets ID of the Blog to call the function on.  Since OneBlog supports only a single blog instance,
        ...
        /// <summary>
        ///     Gets a value indicating whether or not a post will be marked as published by OneBlog.
        /// </summary>
