namespace OneBlog.Core.API.MetaWeblog
{
    using System;
    ...
    internal class MetaWeblogHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                var rootUrl = CoreUtils.AbsoluteWebRoot.ToString();
        ...
        /// </summary>
        /// <param name="blogId">
        /// always 1000 in OneBlog since it is a singlar blog instance
        /// </param>
        /// <param name="userName">
        /// login username
        /// </param>
