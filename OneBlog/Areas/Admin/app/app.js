(function () {
    ...
    var config = ["$routeProvider", function ($routeProvider) {
        $routeProvider
        .when("/", { templateUrl: "/areas/admin/app/dashboard/dashboardView.html" })

        .when("/content/posts", { templateUrl: "/areas/admin/app/content/posts/postView.html" })
        .when("/content/blogs", { templateUrl: "/areas/admin/app/content/blogs/blogView.html" })
        .when("/content/comments", { templateUrl: "/areas/admin/app/content/comments/commentView.html" })
        .when("/content/comments/filters", { templateUrl: "/areas/admin/app/content/comments/commentFilters.html" })
        .when("/content/pages", { templateUrl: "/areas/admin/app/content/pages/pageView.html" })
        .when("/content/categories", { templateUrl: "/areas/admin/app/content/categories/categoryView.html" })
        .when("/content/tags", { templateUrl: "/areas/admin/app/content/tags/tagView.html" })

        .when("/custom/plugins", { templateUrl: "/areas/admin/app/custom/plugins/pluginView.html" })
        .when("/custom/plugins/gallery", { templateUrl: "/areas/admin/app/custom/plugins/pluginGallery.html" })
        .when("/custom/themes", { templateUrl: "/areas/admin/app/custom/themes/themeView.html" })
        .when("/custom/themes/gallery", { templateUrl: "/areas/admin/app/custom/themes/themeGallery.html" })
        .when("/custom/widgets", { templateUrl: "/areas/admin/app/custom/widgets/widgetView.html" })
        .when("/custom/widgets/gallery", { templateUrl: "/areas/admin/app/custom/widgets/widgetGallery.html" })

        .when("/security/profile", { templateUrl: "/areas/admin/app/security/profile/profileView.html" })
        .when("/security/roles", { templateUrl: "/areas/admin/app/security/roles/roleView.html" })
        .when("/security/users", { templateUrl: "/areas/admin/app/security/users/userView.html" })

        .when("/settings/basic", { templateUrl: "/areas/admin/app/settings/basicView.html" })
        .when("/settings/feed", { templateUrl: "/areas/admin/app/settings/feedView.html" })
        .when("/settings/email", { templateUrl: "/areas/admin/app/settings/emailView.html" })
        .when("/settings/comments", { templateUrl: "/areas/admin/app/settings/commentView.html" })
        .when("/settings/controls", { templateUrl: "/areas/admin/app/settings/controlView.html" })
        .when("/settings/advanced", { templateUrl: "/areas/admin/app/settings/advancedView.html" })
        .when("/settings/controls/blogroll", { templateUrl: "/areas/admin/app/settings/controls/blogrollView.html" })
        .when("/settings/controls/pings", { templateUrl: "/areas/admin/app/settings/controls/pingView.html" })
        .when("/settings/tools", { templateUrl: "/areas/admin/app/settings/tools/checkView.html" })
