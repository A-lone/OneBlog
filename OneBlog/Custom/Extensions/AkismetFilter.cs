...
namespace App_Code.Extensions
{
    ...
    /// Akismet Filter
    /// </summary>
    [Extension("Akismet anti-spam comment filter", "1.0", "<a href=\"http://songsong.org\">OneBlog.NET</a>", 0, false)]
    public class AkismetFilter : ICustomFilter
    {
        ...
        public bool Initialize()
        {
            ...
            Api = new Akismet(Key, Site, string.Format("OneBlog.NET {0}", BlogSettings.Instance.Version()));
        ...
        public void Report(Comment comment)
        {
            ...
            {
                CoreUtils.Log(string.Format("Akismet: Reporting SPAM from \"{0}\" at \"{1}\"", comment.Author, comment.IP));
