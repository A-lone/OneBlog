...
/// </summary>
[Extension("Auto resolves URLs in the comments and turn them into valid hyperlinks.", "1.5", "OneBlog.NET")]
public class ResolveLinks
{
    ...
    /// <param name="e">The <see cref="OneBlog.Core.ServingEventArgs"/> instance containing the event data.</param>
