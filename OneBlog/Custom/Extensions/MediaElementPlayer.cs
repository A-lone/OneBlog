...
public class MediaElementPlayer
{
    ...
    static MediaElementPlayer()
    {
        ...
        OneBlog.Core.Page.Serving += Publishable_Serving;
        InitSettings();
    }
...
";
    ...
    {
        OneBlog.Core.Web.Scripting.Helpers.AddScript(page, src, false, true, true);
    }

    private static void AddStylesheet(string href, Page page)
    {
        OneBlog.Core.Web.Scripting.Helpers.AddStyle(page, href);
    }
