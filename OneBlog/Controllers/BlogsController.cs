...
public class BlogsController : ApiController
{
    ...
    public IEnumerable<OneBlog.Core.Data.Models.Blog> Get(int take = 10, int skip = 0, string filter = "", string order = "Name")
    {
    ...
    [HttpPut]
    public HttpResponseMessage Update([FromBody]OneBlog.Core.Data.Models.Blog blog)
    {
	...
	[HttpPut]
    public HttpResponseMessage ProcessChecked([FromBody]List<OneBlog.Core.Data.Models.Blog> items)
    {
