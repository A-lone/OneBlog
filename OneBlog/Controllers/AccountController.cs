...
namespace OneBlog.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //    sb.AppendFormat("<br/><br/>Sincerely,<br/><br/><a href=\"{0}\">{1}</a> team.", CoreUtils.AbsoluteWebRoot, BlogSettings.Instance.Name);
        //    sb.Append("</div>");

        //    mail.Body = sb.ToString();

        //    var msg = CoreUtils.SendMailMessage(mail);
        ...
        //    Response.Redirect(CoreUtils.RelativeWebRoot + "Account/login.aspx");
        //}
