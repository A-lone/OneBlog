...
//        public MemoryRepository(JsonService jsonService)
//        {
...
//        public PostsResult GetPosts(int pageSize = 10, int page = 1)
//        {
//            var posts = _stories.Skip((page - 1) * pageSize).Take(pageSize);
...
//              .Where(s =>
//              {
//                  return s.Content.ToLowerInvariant().Contains(lowerTerm) ||
//                   s.Tags.ToLowerInvariant().Contains(lowerTerm) ||
//                   s.Title.ToLowerInvariant().Contains(lowerTerm);
//              })
...
//            var totalCount = _stories.Where(s => s.Tags.ToLowerInvariant().Split(',').Contains(lowerTag)).Count();

//            var posts = _stories
//              .Where(s => s.Tags.ToLowerInvariant().Split(',').Contains(lowerTag))
//              .Skip((page - 1) * pageSize).Take(pageSize);
//            var postlist = new List<PostItem>();
...
//        public PostDetail Add(PostDetail story)
//        {
...
//        public PostsResult GetPostsByCategory(string category, int pageSize, int page)
//        {
//            throw new NotImplementedException();
//        }
...
//        public PostDetail Update(PostDetail post)
//        {
//            throw new NotImplementedException();
//        }
...
//        public PostsResult GetPosts(int pageSize = 10, int page = 1, Guid? authorId = default(Guid?))
//        {
//            throw new NotImplementedException();
//        }

//        static List<Posts> _stories = new List<Posts>()
//    {
//      new Posts()
//      {
//        IsPublished = true,
