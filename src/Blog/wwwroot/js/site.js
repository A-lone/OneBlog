$(document).ready(function () {
    ...
    n.click(function (t) {
        t.preventDefault(), $(".search-form-container").addClass("is-active"), $(".off-canvas-container").removeClass("is-active"),
            setTimeout(function () { e.focus() }, 500)
    }),

        $(".search-form-container, .close-search-button").on("click keyup",
            function (e) {
